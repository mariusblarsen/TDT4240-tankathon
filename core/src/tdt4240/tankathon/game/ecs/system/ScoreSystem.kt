...
class ScoreSystem(private val game:TankathonGame, private val ecsEngine: ECSengine) : IteratingSystem(allOf(AIComponent:: class, EnemyScoreComponent:: class).get()) {
    ...
    override fun processEntity(entity: Entity, deltaTime: Float) {
        ...
        require(enemyScoreComponent != null) {"Entity |entity| must have a playerScoreComponent. entity =$entity"}
